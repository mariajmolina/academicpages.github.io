...
<object data="./AMS2021_1.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="./AMS2021_1.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="./AMS2021_1.pdf">Download PDF</a>.</p>
    </embed>
</object>
